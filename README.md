...
- The `install.sh system` command installs AMPL directly in the conda environment. If `install.sh` is used, then AMPL is installed in the `$HOME/.local` directory.
