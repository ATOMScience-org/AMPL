...
* The parameter list with detailed explanations of each option can be found at `atom/ddm/docs/PARAMETERS.md <https://github.com/ATOMconsortium/AMPL/blob/master/atomsci/ddm/docs/PARAMETERS.md>`_. 
* Example pipeline JSON files can be found in the tests directory and the example directory.
 

Library documentation
---------------------
**AMPL** includes detailed docstrings and comments to explain the modules. Full HTML documentation of the Python library is available with the package at `atomsci/ddm/docs/build/html/index.html. <https://github.com/ATOMconsortium/AMPL/blob/master/atomsci/ddm/docs/build/html/index.html>`_.
 

More information on AMPL usage
------------------------------
More information on AMPL usage can be found in `Advanced AMPL usage <https://github.com/ATOMconsortium/AMPL#Advanced-AMPL-usage>`_.
